...
@section('style')
<link rel="stylesheet" href={{ asset('frontend/carousel.css')}}>
@endsection
@section('scriptCa')
...
<div class="carousel">
	...
	<div class="carousel-item">
		<div class="carousel-box">
			<div class="title">{{$galerie->galerie_name}}</div>
			<div class="num">{{$galerie->id}}</div>
			<img src="{{asset('storage/galerie_images/'.$galerie->galerie_image)}}" 
			alt={{$galerie->galerie_description}}>		</div>
	</div>
	@endforeach
</div>

<div class="layout">
	<div class="box">Découvrez des séjours inoubliables<br />Votre confort avec des hébergements<br />Ambiance festive</div>
</div>

{{-- <a href="https://www.afrofrenchtouch.com" target="_blank" class="logo">afrofrenchtouch</a> --}}
<div class="social">
